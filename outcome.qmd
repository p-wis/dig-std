...
```{r}
candidate_vars <- c("age", "sex", "race", "ejf_per", "bmi", "creat", "klevel", "chfdur", "nsym", 
          "heartrte", "diabp", "sysbp", "nyha_class", "chfetiol", "prevmi", "angina",
...
## Wstępny model wieloczynnikowy 

```{r}
m1 <- coxph(dwhf_surv ~ age + sex + race + ejf_per + bmi + nyha_class + diguse + diuret + diabp + prevmi + diabetes + hyperten, data = df_trtmt)
summary(m1)
```
