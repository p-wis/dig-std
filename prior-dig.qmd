...
* Hazard Ratio (HR) = `{r} signif(exp(coef(cox_matched)), digits=3)` --- 
...
* 95% przedział ufności: `{r} signif(exp(confint(cox_matched)), digits=3)` – `{r} signif(exp(confint(cox_matched)), digits=3)`  --- Przedział nie obejmuje 1 — efekt jest statystycznie istotny.
